...
<template>
 <NuxtLayout title="Table" hMiddle="Todos" fEnd="Demo">
  <div>
   <UCard class="w-full" :ui="{
    ...
    <!-- Filters -->
    <div class="flex items-center justify-between gap-3 p-2 py-3">
     <UInput v-model="search" icon="i-heroicons-magnifying-glass-20-solid" placeholder="Search..." />
     <USelectMenu v-model="selectedStatus" :options="todoStatus" multiple placeholder="Status" class="w-40" />
    </div>

    <!-- Header and Action buttons -->
    <div class="flex justify-between items-center w-full p-2 py-3">
    ...
    <!-- Table -->
    <UTable v-model="selectedRows" v-model:sort="sort" :rows="todos" :columns="columnsTable"
